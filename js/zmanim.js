...
var Zmanim = (function () {
  ...
  var ALOT_OPTS = [
    ...
    { id: '90', label: '90 דקות לפני הנץ', min: 90, hint: 'מוקדם ב־18 דקות מ־72' },
    { id: '120', label: '120 דקות לפני הנץ', min: 120, hint: 'המוקדם מבין השיטות' },
  ...
  var MISHEYAKIR_OPTS = [
    { id: '45', label: '45 דקות לפני הנץ', min: 45, hint: 'המוקדם מבין השיטות' },
    { id: '52', label: '52 דקות לפני הנץ', min: 52, hint: 'ביניים' },
    { id: '60', label: '60 דקות לפני הנץ', min: 60, hint: 'המאוחר מבין השיטות' },
  ...
  var TZEIT_OPTS = [
    ...
    { id: '18', label: '18 דקות אחרי השקיעה', min: 18, hint: 'מוקדם מהמקובל בלוחות' },
    { id: '20', label: '20 דקות אחרי השקיעה', min: 20, hint: 'מקובל ברבים מהלוחות בארץ' },
    { id: '24', label: '24 דקות אחרי השקיעה', min: 24, hint: 'מאוחר ב־4 דקות מ־20' },
    { id: '25', label: '25 דקות אחרי השקיעה', min: 25, hint: 'מאוחר ב־5 דקות מ־20' },
    { id: '27', label: '27 דקות אחרי השקיעה', min: 27, hint: 'מאוחר ב־7 דקות מ־20' },
    { id: '30', label: '30 דקות אחרי השקיעה', min: 30, hint: 'המאוחר מבין שיטות הדקות' },
  ...
  var SHABBAT_END_OPTS = [
    { id: '25', label: '25 דקות אחרי השקיעה', min: 25, hint: 'מוקדם מהמקובל בלוחות' },
    { id: '30', label: '30 דקות אחרי השקיעה', min: 30, hint: 'מוקדם מהמקובל בלוחות' },
    { id: '35', label: '35 דקות אחרי השקיעה', min: 35, hint: 'מקובל ברבים מהלוחות בארץ' },
    { id: '40', label: '40 דקות אחרי השקיעה', min: 40, hint: 'מאוחר ב־5 דקות מ־35' },
    { id: '42', label: '42 דקות אחרי השקיעה', min: 42, hint: 'מאוחר ב־7 דקות מ־35' },
    { id: '50', label: '50 דקות אחרי השקיעה', min: 50, hint: 'מאוחר מאוד' },
    { id: '72', label: '72 דקות אחרי השקיעה', min: 72, hint: 'שיטת רבנו תם — המאוחר מכולם' },
  ...
  var CANDLE_HINTS = {
    ...
    25: 'מוקדם מהמקובל', 30: 'מנהג חיפה', 40: 'מנהג ירושלים'
  };
