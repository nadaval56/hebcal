...
var Zmanim = (function () {
  ...
  /* ---------- הגדרות שיטות ---------- */
  var ALOT_OPTS = [
    { id: '72', label: '72 דקות לפני הנץ', min: 72 },
    { id: '90', label: '90 דקות לפני הנץ', min: 90 },
    { id: '120', label: '120 דקות לפני הנץ', min: 120 },
    { id: '16.1', label: '16.1 מעלות', deg: 16.1 },
    { id: '19.8', label: '19.8 מעלות', deg: 19.8 }
  ];
  var MISHEYAKIR_OPTS = [
    { id: '45', label: '45 דקות לפני הנץ', min: 45 },
    { id: '52', label: '52 דקות לפני הנץ', min: 52 },
    { id: '60', label: '60 דקות לפני הנץ', min: 60 },
    { id: '10.2', label: '10.2 מעלות', deg: 10.2 },
    { id: '11.5', label: '11.5 מעלות', deg: 11.5 }
  ];
  var TZEIT_OPTS = [
    { id: '13.5', label: '13.5 דקות אחרי השקיעה', min: 13.5 },
    { id: '18', label: '18 דקות אחרי השקיעה', min: 18 },
    { id: '20', label: '20 דקות אחרי השקיעה', min: 20 },
    { id: '24', label: '24 דקות אחרי השקיעה', min: 24 },
    { id: '25', label: '25 דקות אחרי השקיעה', min: 25 },
    { id: '27', label: '27 דקות אחרי השקיעה', min: 27 },
    { id: '30', label: '30 דקות אחרי השקיעה', min: 30 },
    { id: '3.65', label: '3.65 מעלות', deg: 3.65 },
    { id: '4.8', label: '4.8 מעלות', deg: 4.8 },
    { id: '5.95', label: '5.95 מעלות', deg: 5.95 },
    { id: '8.5', label: '8.5 מעלות', deg: 8.5 }
  ];
  var SHABBAT_END_OPTS = [
    { id: '25', label: '25 דקות אחרי השקיעה', min: 25 },
    { id: '30', label: '30 דקות אחרי השקיעה', min: 30 },
    { id: '35', label: '35 דקות אחרי השקיעה', min: 35 },
    { id: '40', label: '40 דקות אחרי השקיעה', min: 40 },
    { id: '42', label: '42 דקות אחרי השקיעה', min: 42 },
    { id: '50', label: '50 דקות אחרי השקיעה', min: 50 },
    { id: '72', label: '72 דקות — רבנו תם', min: 72 },
    { id: '7.083', label: '7.083 מעלות', deg: 7.083 },
    { id: '8.5', label: '8.5 מעלות', deg: 8.5 }
  ];
  ...
  return {
    ...
    SHABBAT_END_OPTS: SHABBAT_END_OPTS, CANDLE_OPTS: CANDLE_OPTS, DEFAULTS: DEFAULTS,
